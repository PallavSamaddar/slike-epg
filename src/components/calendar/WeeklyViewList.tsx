...
const DraggableProgram: FC<{ program: EPGPreviewItem, onEditClick: (program: EPGPreviewItem) => void }> = ({ program }) => {
...
const DroppableCell: FC<{ 
  date: string, 
  programs: EPGPreviewItem[], 
  onEditClick: (program: EPGPreviewItem) => void, 
  onDateClick: (date: string) => void, 
  children?: React.ReactNode 
}> = ({ date, programs, onEditClick, onDateClick, children }) => {
...
const WeeklyViewList: FC<WeeklyViewListProps> = ({ programs, onProgramCopy, onProgramEdit, onDateClick }) => {
            ...
            <div className="flex flex-col">
                <div className="flex">
                    ...
                    {days.map((day, index) => {
                        ...
                        date.setDate(istToday.getDate() - currentDay + index);
                        return (
